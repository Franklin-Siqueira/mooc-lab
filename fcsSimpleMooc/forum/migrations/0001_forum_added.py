# Generated by Django 2.2.3 on 2019-08-07 11:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shortcut', models.SlugField(max_length=100, unique=True, verbose_name='Identifier')),
                ('body', models.TextField(verbose_name='Mensagem')),
                ('views', models.IntegerField(blank=True, default=0, verbose_name='Views')),
                ('answers', models.IntegerField(blank=True, default=0, verbose_name='Responses')),
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='Created on')),
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='Last update')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='threads', to=settings.AUTH_USER_MODEL, verbose_name='Author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='replies', to='forum.Thread', verbose_name='Topic')),
            ],
            options={
                'verbose_name': 'Reply',
